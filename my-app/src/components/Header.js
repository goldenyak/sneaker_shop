        ...
        <header className='d-flex justify-between align-center p-40'>
            ...
            <ul className='d-flex align-center justify-between'>
                <li className='align-center mr-20'>
                    <svg onClick={cartOpened} className='iconCart' width="15" height="15" viewBox="0 0 20 20"
                    ...
                    <span className='cu-p' onClick={cartOpened}>{totalPrice} руб.</span>
                </li>
                <li>
                    <Link to="/favorites">
                ...
                <li>
                    <Link to="/orders">
                        <svg className="iconUser cu-p" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
